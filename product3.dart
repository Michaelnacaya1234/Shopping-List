...
class _ProductsState extends State<Product3> {
  ...
  void initState() {
    ...
    _filteredProducts = List.from(products3);
  ...
  void _filterProducts() {
    ...
    setState(() {
      ...
      List<Map<String, dynamic>> combinedProducts = List.from(products3);
  ...
  void _editPrice(Map<String, dynamic> product) async {
    ...
    if (newPrice != null) {
      setState(() {
        ...
        int hiveIndex = productsBox5.values.toList().indexWhere(
          (item) => item["name"] == product["name"],
        );
        if (hiveIndex != -1) {
          productsBox5.putAt(hiveIndex, product);
        }
      });
    }
  }
