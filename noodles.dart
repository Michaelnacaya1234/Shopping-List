...
class _ProductsState extends State<Noodles> {
  ...
  void initState() {
    ...
    _filteredProducts = List.from(ororama1);
  ...
  void _filterProducts() {
    ...
    setState(() {
      ...
      List<Map<String, dynamic>> combinedProducts = List.from(ororama1);
  ...
  void _editPrice(Map<String, dynamic> product) async {
    ...
    if (newPrice != null) {
      setState(() {
        ...
        int hiveIndex = productsBox2.values.toList().indexWhere(
          (item) => item["name"] == product["name"],
        );
        if (hiveIndex != -1) {
          productsBox2.putAt(hiveIndex, product);
        }
      });
    }
  }
