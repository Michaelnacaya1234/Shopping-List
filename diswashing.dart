...
class Diswashing extends StatefulWidget {
  const Diswashing({super.key});

  @override
  _ProductsState createState() => _ProductsState();
}

class _ProductsState extends State<Diswashing> {
  ...
  void initState() {
    ...
    _filteredProducts = List.from(ororama7);
  ...
  void _filterProducts() {
    ...
    setState(() {
      ...
      List<Map<String, dynamic>> combinedProducts = List.from(ororama7);
