...
class _ProductsState extends State<Product6> {
  ...
  void initState() {
    ...
    _filteredProducts = List.from(products6);
  ...
  void _filterProducts() {
    ...
    setState(() {
      ...
      List<Map<String, dynamic>> combinedProducts = List.from(products6);
  ...
  void _editPrice(Map<String, dynamic> product) async {
    ...
    if (newPrice != null) {
      setState(() {
        ...
        int hiveIndex = productsBox8.values.toList().indexWhere(
          (item) => item["name"] == product["name"],
        );
        if (hiveIndex != -1) {
          productsBox8.putAt(hiveIndex, product);
        }
      });
    }
  }
