...
import 'package:database/productlist.dart';
import 'package:flutter/material.dart';
import 'package:hive_flutter/hive_flutter.dart';
import 'package:speech_to_text/speech_to_text.dart' as stt;

class Product9 extends StatefulWidget {
  const Product9({super.key});

  @override
  _ProductsState createState() => _ProductsState();
}

class _ProductsState extends State<Product9> {
  ...
  void initState() {
    ...
    _filteredProducts = List.from(products9);
  ...
  void _filterProducts() {
    ...
    setState(() {
      ...
      List<Map<String, dynamic>> combinedProducts = List.from(products9);
  ...
  void _editPrice(Map<String, dynamic> product) async {
    ...
    if (newPrice != null) {
      setState(() {
        ...
        // Update Hive if the product is in productsBox
        int hiveIndex = productsBox11.values.toList().indexWhere(
          (item) => item["name"] == product["name"],
        );
        if (hiveIndex != -1) {
          productsBox11.putAt(hiveIndex, product);
        }
      });
    }
  }
  ...
  void _editProductDetails(Map<String, dynamic> product) async {
    ...
    if (newDetails != null) {
      setState(() {
        ...
        _priceBox.put(product["name"], newDetails["price"]);
        // Update Hive if the product is in productsBox
        int hiveIndex = productsBox11.values.toList().indexWhere(
          (item) => item["name"] == product["name"],
        );
