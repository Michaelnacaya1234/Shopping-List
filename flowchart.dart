...
// Define Hive boxes (removed Ororama boxes since they're no longer needed)
...
// Placeholder for drawerOrorama - replace with actual implementation
Widget drawerOrorama(BuildContext context) {
  return Drawer(
    child: ListView(
...
class MallComparison extends StatefulWidget {
  const MallComparison({super.key});

  @override
  _MallComparisonState createState() => _MallComparisonState();
}

class _MallComparisonState extends State<MallComparison>
      ...
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          indicator: UnderlineTabIndicator(
            borderSide: BorderSide(color: Colors.white60, width: 4.0),
          ),
          tabs: const [Tab(text: "Gaisano"), Tab(text: "Comparison")],
        ),
      ),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      "₱${(gaisanoTotal - ororamaTotal).abs().toStringAsFixed(2)}",
                      style: TextStyle(
                        color:
                            gaisanoTotal > ororamaTotal
                                ? Colors.red
                                : Colors.green,
                        fontWeight: FontWeight.bold,
                      ),
          ...
          const SizedBox(height: 10),
          Expanded(child: _buildComparisonTable(gaisanoSpent, ororamaSpent)),
        ],
      ),
    );
  }
  ...
  Widget _buildComparisonTable(
    ...
    Set<String> allItems = {...gaisanoSpent.keys, ...ororamaSpent.keys};
    List<DataRow> rows = [];
    int index = 0;
    ...
    for (var item in allItems) {
      ...
      final cheaperMall =
          gaisanoPrice < ororamaPrice
              ? "Gaisano"
              : (gaisanoPrice > ororamaPrice ? "Ororama" : "Equal");
