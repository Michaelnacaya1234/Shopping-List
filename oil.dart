...
class _ProductsState extends State<Oil> {
  ...
  void initState() {
    ...
    _filteredProducts = List.from(ororama2);
  ...
  void _filterProducts() {
    ...
    setState(() {
      ...
      List<Map<String, dynamic>> combinedProducts = List.from(ororama2);
  ...
  void _editPrice(Map<String, dynamic> product) async {
    ...
    if (newPrice != null) {
      setState(() {
        ...
        int hiveIndex = productsBox3.values.toList().indexWhere(
          (item) => item["name"] == product["name"],
        );
        if (hiveIndex != -1) {
          productsBox3.putAt(hiveIndex, product);
        }
      });
    }
  }
