...
import 'package:database/products_all.dart';
...
class _ProductsState extends State<AllProducts> {
  ...
  final Box productsBox = Hive.box('productsBox');

  final Box productsBox1 = Hive.box('canned');
  final Box productsBox2 = Hive.box('noodles');
  final Box productsBox3 = Hive.box('sauce');
  final Box productsBox4 = Hive.box('coffee');
  final Box productsBox5 = Hive.box('Chocolates');
  final Box productsBox6 = Hive.box('biscuit');
  final Box productsBox7 = Hive.box('wines');
  final Box productsBox8 = Hive.box('diswashing');
  final Box productsBox9 = Hive.box('rice');
  final Box productsBox10 = Hive.box('meat');
  final Box productsBox11 = Hive.box('hair');
  ...
  void _loadAllProducts() {
    List<Map<String, dynamic>> combinedProducts = List.from(all_products ?? []);
