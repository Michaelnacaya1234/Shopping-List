...
class Productso extends StatefulWidget {
  const Productso({super.key});

  @override
  _ProductsState createState() => _ProductsState();
}

class _ProductsState extends State<Productso> {
  ...
  final Box productsBox1 = Hive.box('canneds'); // Canned
  final Box productsBox2 = Hive.box('noodless'); // Instant Noodles / Pasta
  final Box productsBox3 = Hive.box('sauces'); // Cooking oil / Sauce
  final Box productsBox4 = Hive.box('coffees'); // Coffee / Powdered milk
  final Box productsBox5 = Hive.box('Chocolatess'); // Chocolates / Candies
  final Box productsBox6 = Hive.box('biscuits'); // Biscuit / JunkFoods
  final Box productsBox7 = Hive.box('winess'); // Wines
  final Box productsBox8 = Hive.box('diswashings'); // Dishwashing
  final Box productsBox9 = Hive.box('rices'); // Rice / Sugar
  final Box productsBox10 = Hive.box('meats'); // Fresh meat / Frozen Goods
  final Box productsBox11 = Hive.box('hairs'); // Hair care / Soaps
      ...
      bottomNavigationBar: BottomNavigationBar(
            ...
            icon: IconButton(
              onPressed:
                  () => Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const Ororamalist(),
                    ),
                  ),
        ...
        onTap: (index) {
          if (index == 2) {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => const Ororamalist()),
            );
          }
        },
      ),
