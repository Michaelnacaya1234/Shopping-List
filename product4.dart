...
class _ProductsState extends State<Product4> {
  ...
  void initState() {
    ...
    _filteredProducts = List.from(products4);
  ...
  void _filterProducts() {
    ...
    setState(() {
      ...
      List<Map<String, dynamic>> combinedProducts = List.from(products4);
  ...
  void _editPrice(Map<String, dynamic> product) async {
    ...
    if (newPrice != null) {
      setState(() {
        ...
        int hiveIndex = productsBox6.values.toList().indexWhere(
          (item) => item["name"] == product["name"],
        );
        if (hiveIndex != -1) {
          productsBox6.putAt(hiveIndex, product);
        }
      });
    }
  }
