...
class OroramaHome extends StatefulWidget {
  const OroramaHome({super.key});

  @override
  State<OroramaHome> createState() => _OroramaHomeState();
}

class _OroramaHomeState extends State<OroramaHome>
    with SingleTickerProviderStateMixin {
  final List<String> _mallList = ['Ororama', 'Gaisano'];
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text(
            mall == 'Ororama'
                ? "You're now in Ororama Mall!"
                : "Are you going to change Gaisano Mall?",
          ...
          BottomNavigationBarItem(
            icon: IconButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const Productso()),
                );
              },
