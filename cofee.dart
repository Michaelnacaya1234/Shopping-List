...
class _ProductsState extends State<Coffe> {
  ...
  void initState() {
    ...
    _filteredProducts = List.from(ororama3);
  ...
  void _filterProducts() {
    ...
    setState(() {
      ...
      List<Map<String, dynamic>> combinedProducts = List.from(ororama3);
  ...
  void _editPrice(Map<String, dynamic> product) async {
    ...
    if (newPrice != null) {
      setState(() {
        ...
        int hiveIndex = productsBox4.values.toList().indexWhere(
          (item) => item["name"] == product["name"],
        );
        if (hiveIndex != -1) {
          productsBox4.putAt(hiveIndex, product);
        }
      });
    }
  }
